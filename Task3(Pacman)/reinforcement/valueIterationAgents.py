...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        for i in range(self.iterations):
            ...
            # This ensures V_k+1 depends on V_k, not partially updated values
    ...
    def computeQValueFromValues(self, state, action):
        ...
        for nextState, prob in transitions:
            ...
            # Add this transition's contribution to the Q-value
            # Q-value = sum of: probability * (reward + discount * value of next state)
    ...
    def computeActionFromValues(self, state):
        ...
        """
        # Terminal state or no legal actions
        if self.mdp.isTerminal(state):
            return None
